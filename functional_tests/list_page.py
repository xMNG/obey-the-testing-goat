...
class ListPage(object):
    """
    This class is a PageObject, captures all features of the list view page in one place.
    Aggregated source of interation with list page in one place.
    """
    def __init__(self, test):
        """
        :param test: ListPage is called with other functional tests (self)
        """
        self.test = test
